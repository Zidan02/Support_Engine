...
export default function Tabs({ active, setActive, tabs }: TabsProps) {
  ...
  return (
    <div className="flex flex-wrap gap-10 mb-10 justify-center relative">
      {tabs.map((tab) => (
        <button
          key={tab.id}
          ...
          className={`relative flex-1 text-center py-2 rounded-full bg-slate-200 text-sm transition z-10 ${
